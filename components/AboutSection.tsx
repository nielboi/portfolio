...
export default function AboutSection() {
  ...
  return (
    <>
      ...
      {/* scroll-mt- to make space when navigating from other tabs*/}
      <section id="about-mobile" className="lg:hidden w-full py-16 px-4 scroll-mt-[10vh]">
            ...
            {mobileAboutCards.map((card, i) => (
              ...
              >
                ...
                <div className="p-5 pb-0 text-[#F4EBDD] relative z-10">
                  ...
                  <p className="text-sm font-light opacity-80 leading-relaxed tracking-wide">
                    {card.text}
                  </p>
                </div>
                {/* Card Image - large, bottom right, overflows/clips */}
                <div className="relative w-full h-[55vw] mt-2">
                  <div className={`absolute right-[-8%] bottom-[-12%] ${i === 0 ? 'bottom-[-19%] w-[70%] h-[110%]' : 'w-[60%] h-[90%]'}`}>
                    <Image
                      src={card.image}
                      alt={`about card ${i}`}
                      fill
